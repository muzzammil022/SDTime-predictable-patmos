...
export default function EditorTabs({ tabs, activeTabId, onTabClick, onTabClose }: EditorTabsProps) {
  return (
    <div className="h-9 bg-slate-900/50 border-b border-white/[0.06] flex items-end overflow-x-auto flex-shrink-0">
      {tabs.map((tab) => {
        ...
        return (
          <div
            ...
            className={`group relative flex items-center gap-1.5 h-[34px] px-3 cursor-pointer select-none
              border-r border-white/[0.04] transition-colors duration-150 min-w-0 max-w-[160px]
              ${isActive
